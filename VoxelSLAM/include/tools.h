...
extern const Eigen::Matrix3d I33;
...
struct IMUST
{
  ...
  IMUST(double _t, const Eigen::Matrix3d &_R, const Eigen::Vector3d &_p, const Eigen::Vector3d &_v, const Eigen::Vector3d &_bg, const Eigen::Vector3d &_ba, const Eigen::Vector3d &_g = Eigen::Vector3d(0, 0, -G_m_s2), const Eigen::Vector3d &_acc = Eigen::Vector3d::Zero(), const Eigen::Vector3d &_omg = Eigen::Vector3d::Zero()) : t(_t), R(_R), p(_p), v(_v), bg(_bg), ba(_ba), g(_g), acc(_acc), omg(_omg) {}
